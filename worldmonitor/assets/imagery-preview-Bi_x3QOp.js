import{s as o,t as l,a as t}from"./panels-DgorFJrR.js";import{g as c,s as d}from"./cross-domain-storage-BkfZ6fhr.js";const i="wm-layer-warning-dismissed";let r=null;function u(a){if(c(i)||r||window.self!==window.top||new URLSearchParams(window.location.search).get("alert")==="false")return;const e=document.createElement("div");e.className="layer-warn-overlay",o(e,l(`
